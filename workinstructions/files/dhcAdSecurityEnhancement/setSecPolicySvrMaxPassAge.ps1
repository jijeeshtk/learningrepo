...
.DESCRIPTION    
	...
	- Domain member: Disable machine account password changes	Disabled (0)
...
$gpoPol = @(
    New-Object psobject -Property @{Name  = 'Domain member: Disable machine account password changes';
      Key   = 'MACHINE\System\CurrentControlSet\Services\Netlogon\Parameters\DisablePasswordChange';
      Value = '0';
      Type  = '4'}
    New-Object psobject -Property @{Name  = 'Domain member: Maximum machine account password age';
